...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gallery.category'
        db.alter_column('filer_gallery_gallery', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Gallery.category'
        raise RuntimeError("Cannot reverse this migration. 'Gallery.category' and its values cannot be restored.")
